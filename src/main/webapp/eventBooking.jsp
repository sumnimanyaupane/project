...
<div class="login-container">
    ...
    <form class="login-form" action="eventBooking" method="post" onsubmit="return validateForm()">
        ...
        <button type="submit" class="loginbtn">Confirm Booking and Set Menu</button>
    </form>
