...
<div class="container">
    <div class="card">
        <img src="hotel4.jpeg" alt="image">
        <div class="card-content">
            <h2>Hotel Srikhanda</h2>
            <h4>Let’s start the planning process. Contact us for more information or to schedule
                an appointment.
                Tel:+977 980 2078405
                kathmandu.srikhanda@hotel.com</h4>
            <form action="AdminTableChecking.jsp">
                <input type="submit" value="SHOW ROOM DETAILS" class="loginbtn">
            </form>
        </div>
    </div>
    <div class="card">
        ...
        <div class="card-content">
            ...
            <form action="AdminTableBooking.jsp">
                <input type="submit" value="SHOW ROOM BOOKING DETAILS " class="loginbtn">
            </form>
        </div>
    </div>
        <div class="card">
            ...
            <div class="card-content">
                ...
                <form action="adminEvent.jsp">
                    <input type="submit" value="SHOW EVENT BOOKING DETAILS" class="loginbtn">
                </form>
            </div>
        </div>
</div>
...
<%--<form action="navbar1.jsp">--%>
<%--    <input type="submit" value="Back to home page" class="loginbtn">--%>
<%--</form>--%>
